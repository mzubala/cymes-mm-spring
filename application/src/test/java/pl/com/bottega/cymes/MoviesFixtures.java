...
class MoviesFixtures {
    ...
    private void createStars() {
        assertSuccess(
            moviesApi.createStar(new CreateStarRequest("Christian", null, "Bale")),
    ...
    private void createGenres() {
        assertSuccess(
            moviesApi.createGenre(new CreateGenreRequest("Drama")),
        ...
        assertSuccess(
            moviesApi.createMovie(
                new CreateMovieRequest(
                    "Batman",
                    "test description",
                    Set.of(moviesApi.getGenreId("Drama"), moviesApi.getGenreId("Thriller")),
                    moviesApi.getStarId("Nolan"),
                    Set.of(moviesApi.getStarId("Bale")),
                    120
                )
            ),
            moviesApi.createMovie(
                new CreateMovieRequest(
                    "The Godfellas",
                    "test description",
                    Set.of(moviesApi.getGenreId("Drama")),
                    moviesApi.getStarId("Scorsese"),
                    Set.of(moviesApi.getStarId("DeNiro"), moviesApi.getStarId("Pesci")),
                    113
                )
            )
        );
